...
@section('content')
    <div class="card">
        ...
        @if(in_array($order->status, ['pending', 'confirmed']))
            <form action="{{ route('orders.cancel', $order) }}" method="POST" onsubmit="return confirm('Yakin ingin membatalkan pesanan ini?')" style="margin-top:18px;">
                @csrf
                @method('PATCH')
        ...
        <h3 style="margin-top:24px;">Tracking Pesanan</h3>
